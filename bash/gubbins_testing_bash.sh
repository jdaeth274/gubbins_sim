...
dir="rec-0.1-0.1-0.01";
mkdir ${dir};
cd ${dir};
perl ~/Dropbox/phd/gubbins_testing/analysis_code/generate_taxa.pl -a ../strep_alignment/split_kmers/strep_53_aln.aln \
-o 100_iso_run -n 100 -m ../26_phage.mfa -i 0.01 -b 0.1 -r 0.1
