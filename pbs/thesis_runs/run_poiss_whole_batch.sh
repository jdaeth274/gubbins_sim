...
cd ~/../ephemeral/gubbins_testing/poisson_runs
...
SIMUL_LOC ="/rds/general/user/jd2117/ephemeral/gubbins_testing/simul_data/poisson_data/"
...
do
	...
	then
		...
		START_GUB=$SECONDS
		/usr/bin/time -v python ~/gubbins/python/run_gubbins.py --prefix "${MAIN_MODEL}-rep-${K}-${BASIO}-JC-JC" --use-time-stamp --threads 1 --verbose \
